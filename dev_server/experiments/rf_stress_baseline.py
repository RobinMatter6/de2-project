...
print("--- RANDOM FOREST STRESS TEST (BASELINE / SINGLE NODE) ---")
...
print("\nStarting training on a single machine with 100k rows...")
...
print(f"\nRF Baseline Stress Test Total Training Time: {execution_time:.2f} seconds")