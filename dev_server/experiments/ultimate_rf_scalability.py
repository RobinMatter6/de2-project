...
print("Connecting to Ray cluster for ULTIMATE RF SCALABILITY TEST...")
ray.init(address='auto')

# Loading and inflating the dataset to 300,000 rows
...
# Expanded parameter grid from tuning script
param_grid = {
    'model__n_estimators': [100, 200, 300, 500], 
    'model__max_depth': [10, 20, 30, None],       
}

# Changed to 3-fold CV as requested
...
print("\n" + "="*50)
print("STARTING ULTIMATE RANDOM FOREST SCALABILITY TEST (300,000 Rows, 3 Folds, Huge Grid)")
print("="*50)
...
print("\n" + "="*50)
print("FINAL ULTIMATE RANDOM FOREST SCALABILITY RESULTS:")
