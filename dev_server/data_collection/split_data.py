...
input_file = '../../data/raw/top_1000_github_repos_with_commits_v2.csv'
...
train_df.to_csv('../../data/processed/model_train_data.csv', index=False)
scoring_df.to_csv('../../data/processed/model_scoring_data.csv', index=False)
